...
Если репозиторий публичный, эти данные смогут увидеть посторонние. Для личного конфига рекомендуется использовать **приватный репозиторий** или предварительно заменить секретные значения.
